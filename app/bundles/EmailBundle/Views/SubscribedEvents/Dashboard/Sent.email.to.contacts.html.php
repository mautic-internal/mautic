                ...
                <tr>
                    <?php if (is_array($row)) : ?>
                        <?php foreach ($row as $key => $item) : ?>
                            ...
                            <td>
                                <?php if ($key === 'contact_email' && $row['contact_id']) : ?>
